$(document).ready(function(){
  ...
  function drawCharts() {
    ...
    var width = $("#activity_chart").width();
      ...
      getData('stats.activity.daily.incremental_count', '10min', '-14d', false, 'addActivityData');
    ...
    plotRetentionChart = function(){
      ...
      // get data from graphite, iterate, pass into data via addRow
      getData('stats.activity.retention.weekly', '1d', '-21d', false, 'addRetentionData');
