...
$(document).ready(function(){
  ...
  setInterval(function(){
    ...
    getData('stats.engagement.daily.threshold.7', '1d', 'midnight+today', false, 'renderTodaysDEU');
    getData('stats.engagement.daily.threshold.7', '1d', 'noon+yesterday', 'midnight+today', 'renderYesterdaysDEU');
...
var renderTodaysDEU = function(d){
  if (d.datapoints.length == 0 || escape(d.target) != escape('hitcount(stats.engagement.daily.threshold.7, "1d")') ){ 
    $("#error").text("something is wrong with getting data, sorry dude.").show();
  }
